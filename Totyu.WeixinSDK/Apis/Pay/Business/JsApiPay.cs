...
namespace Totyu.WeixinSDK.Apis.Pay.Business
{
    public class JsApiPay
    {
        ...
        public void GetOpenidAndAccessTokenFromCode(string code)
        {
            try
            {
                ...
                WxPayData data = new WxPayData();
                data.SetValue("appid", GlobalContext.AppID);
                data.SetValue("secret", GlobalContext.AppSecret);
                data.SetValue("code", code);
                data.SetValue("grant_type", "authorization_code");
                string url = "https://api.weixin.qq.com/sns/oauth2/access_token?" + data.ToUrl();

                //请求url以获取数据
                dynamic result = HttpClientHelper.HttpClientGetJsonAsync(url);
        ...
        public string GetJsApiParameters()
        {
            ...
            jsApiParam.SetValue("timeStamp", CommonHelper.CreateTimestamp());
            jsApiParam.SetValue("nonceStr", CommonHelper.CreateNonceStr());
