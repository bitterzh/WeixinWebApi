...
namespace Totyu.WeixinSDK.Apis.Open
{
    /// <summary>
    ...
    public class OAuth2API : BaseAPI
    {
        ...
        {
            string _url = string.Format(ApiUrlHelper.OpenApiUrl.GetCode, appId, RequestUtility.UrlEncode(redirectUri), scope, state);
        ...
        {
            string _url = string.Format(ApiUrlHelper.OpenApiUrl.GetAccessToken, appId, appSecret, code);
            return GetJsonAsync(_url);
        }
        /// <summary>
        ...
        {
            string _url = string.Format(ApiUrlHelper.OpenApiUrl.RefreshAccessToken, appId, refreshToken);
            return GetJsonAsync(_url);
        }
        /// <summary>
        ...
        {
            string _url = string.Format(ApiUrlHelper.OpenApiUrl.GetUserInfo, accessToekn, openId, lang);
            return GetJsonAsync(_url);
        }
    }
}
