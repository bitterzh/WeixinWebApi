...
namespace Totyu.WeixinSDK.Entiyies.Dynamic
{
    public class DynamicJson : DynamicObject
    {
        ...
        private static string m_JsonString;
        ...
        public string JsonString { get { return m_JsonString; } }

        /// <summary>
        /// create blank JSObject
        /// </summary>
        public DynamicJson()
        {
        ...
        /// <returns></returns>
        public static dynamic Parse(string json, Encoding encoding = null)
        {
            if (encoding == null)
        ...
        #region serialize
        /// <summary>
        /// mapping to Array or Class by Public PropertyName
        /// </summary>
        ...
        /// <summary>
        /// create JsonSring from primitive or IEnumerable or 
        /// Object({public property name:property value})
        /// </summary>
