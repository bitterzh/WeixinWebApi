...
namespace Totyu.WeixinSDK.Helper
{
    ...
    public class AccessTokenHelper
    {
        ...
        /// </param>
        public AccessTokenHelper(int IntervalInSeconds, string appId, string appSecrect, bool isOpenJSTickect = false)
        {
        ...
        private void refreshJSTickect()
        {
            ...
            try
            {
                string newTickect = JSSDKAPI.GetTickect(_token).ticket;
